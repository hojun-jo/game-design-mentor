...
GRAPH_PROGRESS_MESSAGES: dict[str, str] = {
    ...
    "discover_reference_games": "기획과 비교할 유사 레퍼런스 게임을 찾았습니다.",
    "prepare_reference_lookup": "입력 및 추천 레퍼런스 게임을 조회할 준비를 했습니다.",
    "reference_lookup_tool_node": "레퍼런스 게임의 공개 정보를 확인했습니다.",
    "merge_reference_lookup_results": "레퍼런스 조회 결과를 리뷰 컨텍스트에 합쳤습니다.",
    "mark_reference_lookup_skipped": "비교 가능한 레퍼런스가 없어 조회를 건너뛰었습니다.",
...
GRAPH_NEXT_PROGRESS_MESSAGES: dict[str, str] = {
    ...
    "discover_reference_games": "찾은 레퍼런스 게임의 공개 정보를 확인하고 있습니다.",
    "prepare_reference_lookup": "입력 및 추천 레퍼런스 게임의 공개 정보를 확인하고 있습니다.",
...
def _review_context_for_chat(result: ReviewResponse) -> dict:
    return {
        ...
        "reference_discovery_status": result.reference_discovery_status,
        "reference_discovery_notes": result.reference_discovery_notes,
...
def _build_response(state: MentorState) -> ReviewResponse:
    ...
    return ReviewResponse(
        ...
        reference_discovery_status=state.get("reference_discovery_status", "skipped"),
        reference_discovery_notes=state.get("reference_discovery_notes", []),
